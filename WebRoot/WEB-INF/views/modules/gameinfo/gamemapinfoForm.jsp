		...
		<tr style="height:27%;width: 90%;" >
			<td style="width: 100%;border: 1px solid #007274;">
				<table style="height: 100%;">
					...
					<tr>
						<td> 收缩耗时 <input type="number" id="cirinjtime" min="0.0" step="0.1" required="required" onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )' /> </td>
					</tr>
					<tr>
						<td> 变化间隔 <input type="number" id="cirtime" min="0.0" step="0.1" required="required" onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )' /> </td>
					</tr>
					<tr>
						<td> 初始伤害 <input type="number" id="startinj" min="0.0" step="0.1" required="required" onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )' /> </td>
					</tr>
					<tr>
						<td> 增加伤害 <input type="number" id="everyinj" min="0.0" step="0.1" required="required" onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )' /> </td>
					</tr>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="remarktime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${gamemapinfo.remarktime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
