...
<body>
	<div class="logintop">    
	    ...
	    <ul>
	    <li><a href="#">返回首页</a></li>
	    <li><a href="javascript:void(0);" onclick="reg()" >帮助</a></li>
	    <li><a href="#">关于</a></li>
	    </ul>
    </div>
							...
							<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
								<fieldset>
									...
									<div class="clearfix">
										...
										<div >
	                                     <button type="button"  onclick="regredit()"  class="width-35 pull-right btn btn-sm btn-primary"   style="width:100px;height:30px;margin-right:25px;" >
											<i class="icon-key" >&nbsp;注册</i>
										</button>
										
									    
										<%-- <a href="${ctx}/register" onclick="regredit()" id="reg" >注册</a> --%>
										</div> 
									    <div >
										<button type="submit" class="width-35 pull-right btn btn-sm btn-primary"  style="width:100px;height:30px;margin-right:30px;" id="login_btn">
