...
<head>
	...
	<script type="text/javascript">
		...
		$("#hpnumber").hide();
		$("#everyinjur").hide();
		if($('input[type=radio][name=adjusthp]').val()=='0'){
			$("#hpnumber").show();		
		}else{
			$("#hpnumber").hide();
		}
...
<%-- 	<ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="gamehome" action="${ctx}/gamehomeinfo/gamehome/setrromm" method="post" class="form-horizontal">
		<form:hidden path="id"/>

		<sys:message content="${message}"/>		
		<div style="text-align: center;" class="control-group">
			<span style="font-size: 18px;font-family: Microsoft Yahei;margin-top: 10%;"> 修改游戏属性 </span>
		</div>		
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:radiobutton path="adjusthp" value="1"/>关闭调整
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div id="hpnumber"  class="control-group">
			...
			<div class="controls">
				<form:input type="number" path="peohp" id="peophp" htmlEscape="false" maxlength="11" class="input-xlarge required"  />
			</div>
		</div>
		<div style="display: none;" class="control-group">
		...
		<div id="startinjur" class="control-group">
			...
			<div class="controls">
				...
				<form:radiobutton path="startinjur" value="1"/>关闭
				<span class="help-inline"><font color="red">*</font> </span>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobutton path="teamtype" value="0" />自选组队
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="createby" htmlEscape="false" maxlength="50" value="${fns:getUser().name}"  class="input-xlarge required"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="gamehomeinfo:gamehome:edit"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="tosubmint()" value="保 存"/>&nbsp;</shiro:hasPermission>
